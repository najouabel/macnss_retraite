...
public class FileService {
    ...
    Document createDocument(String type,Scanner scanner){
        ...
        int amount = tools.tryParse(scanner.nextLine());
        while(amount == 0){
            System.out.print("Invalid, Enter a number: ");
            amount = tools.tryParse(scanner.nextLine());
        }
    ...
    public void addFile(Scanner scanner)  {
        ...
        if(choice == 1){
            ...
            patient = authenticationService.addPatient(scanner);
            if (patient != null) {
...
//                        }
    ...
    public boolean sendStatusVerificationEmail(int matricule, RefundFileStatus newStatus){
        ...
        String Sbj= "Macnss :  Your file update : ";
        String Msg="Your File status is : "+status;
    ...
    public void editFile(Scanner scanner){
        ...
        int newFileStatus = tools.tryParse(scanner.nextLine());
        while(newFileStatus < 1 || newFileStatus > 3){
            System.out.print("Invalid, Enter your choice again: ");
            newFileStatus = tools.tryParse(scanner.nextLine());
        }
        if(newFileStatus == 1){
